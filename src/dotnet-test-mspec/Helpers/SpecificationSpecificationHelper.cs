...
namespace Machine.Specifications.Runner.DotNet.Helpers
{
    ...
    {
        public static IEnumerable<SpecificationsForAssembly> GetSpecificationsToRunPerAssemblyFromTestStrings(IEnumerable<ContextInfo> contexts, IEnumerable<Assembly> assemblies, string[] testStrings)
        {
            ...
            return testPerAssemblies.Select(t => new SpecificationsForAssembly(t.Key, t.Value));
        }
